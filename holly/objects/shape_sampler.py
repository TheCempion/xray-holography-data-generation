...
# local libraries
import holly.objects.shape_builder as module_shape_builder
from holly.objects.shape_builder import ShapeBuilder
...
class ShapeSampler:
    def __init__(self, shapes: List[str], rotate: bool, **kwargs) -> None:
        ...
        for shape in shapes:
            builder = init_obj(
                f"{shape}Builder", module_shape_builder, module_args=kwargs
            )
