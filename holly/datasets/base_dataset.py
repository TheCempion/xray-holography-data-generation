...
# local libraries
from holly.parse_config import init_obj
import holly.utils.transforms as custom_transforms
        ...
        *,
        ...
        Args:
            ...
            augmentations (List[Dict[str, Any] | str] | None, optional): List containing either the class name of a
                        ...
                        a custom transform from the module `holly.utils.transform` or a pytorch
        ...
        self.transform = self._load_transform(
            remove_outliers, as_tuple=as_tuple, augmentations=augmentations
        )
