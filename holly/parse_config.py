...
# local packages
import holly.experiment.setup as module_setup
import holly.experiment as experiment
from holly.utils.datatypes import Pathlike
import holly.utils.fileIO as fileIO
from holly.configs import DEFAULT_CONFIG_PATH
...
def init_obj(
    module_name: str, module: ModuleType, module_args: Dict[str, Any], *args, **kwargs
) -> Any:
    assert all(
    ...
    try:
        ...
        import holly.custom as module_custom
